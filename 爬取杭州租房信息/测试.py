...
def urls(url):
    ...
    for i  in range(28,36):
        url1="https://hz.5i5j.com/zufang/binjiangqu/u1"+"n"+format(i)+'/'
        usrs.append(url1)
    return  usrs
...
def get_page_pares(url,headers):
    ...
    #  返回sql语句
    sqls = []
    for title,descrable,pric,more_address13,rent_type in zip(titles,desc,price,more_address1,rent_types):
        str = "insert into  rent_info values ('%s','%s','%s','%s','%s')"%(title,descrable,more_address13,pric,rent_type)
        sqls.append(str)
...
if __name__ == '__main__':
    ...
    url = 'https://hz.5i5j.com/zufang/binjiangqu/u1/'
    get_urls=urls(url)
