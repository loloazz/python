...
proxies_list=[]
urls =[]
for i in range(525,536):
    url = 'https://www.kuaidaili.com/free/inha/'+format(i)
    urls.append(url)


for url in urls:
    print(f"=============正在爬取{url}页数据============")
    page= requests.get(url,headers=headers).text
    parser= etree.HTML(page)
    ip=parser.xpath('''//*[@id='list']/table/tbody//td[1]/text()''')
    post=parser.xpath('''//*[@id="list"]/table/tbody//td[2]/text()''')
...
print(proxies_list)
print('获取ip代理数量',len(proxies_list))
